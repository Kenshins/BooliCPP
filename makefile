...
DEPS= jsonRetriverInterface.h jsonRetriver.h searchCondition.h urlGeneratorInterface.h urlGenerator.h $(AUTOGENJSONDIR)/Listings.h $(AUTOGENJSONDIR)/Address.h $(AUTOGENJSONDIR)/Areas.h $(AUTOGENJSONDIR)/Location.h $(AUTOGENJSONDIR)/Position.h $(AUTOGENJSONDIR)/Region.h $(AUTOGENJSONDIR)/Booliresult.h $(AUTOGENJSONDIR)/SearchParams.h $(AUTOGENJSONDIR)/Sold.h $(AUTOGENJSONDIR)/Source.h curlException.h Booli.h BooliFactory.h

OBJ= jsonRetriver.o urlGenerator.o searchCondition.o $(AUTOGENJSONDIR)/Listings.o $(AUTOGENJSONDIR)/Address.o $(AUTOGENJSONDIR)/Areas.o $(AUTOGENJSONDIR)/Location.o $(AUTOGENJSONDIR)/Position.o $(AUTOGENJSONDIR)/Region.o $(AUTOGENJSONDIR)/Booliresult.o $(AUTOGENJSONDIR)/SearchParams.o $(AUTOGENJSONDIR)/Sold.o $(AUTOGENJSONDIR)/Source.o Booli.o BooliFactory.o
